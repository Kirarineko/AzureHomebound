---
description: 开一个跨 session 的长期任务. 在 .whatsnext/tasks/ 建落脚点并接管 Focus
---
...
Read `<基准>/references/start.md`(项目安装时基准 = `.opencode/skills/whatsnext/`, 全局安装时 = `~/.config/opencode/skills/whatsnext/`), 严格按其步骤开新任务. 该文件是权威规范, 以它为准. 用户输入的任务描述: $ARGUMENTS
